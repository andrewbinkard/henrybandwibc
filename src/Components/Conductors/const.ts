...
import KatherineNorrisHeadshot from "../../assets/Conductors/Kat_Norris.jpg";
import SamuelSommerHeadshot from "../../assets/Conductors/Sam_Sommer.jpg";
import JorgeRiveraHeadshot from "../../assets/Conductors/Jorge_Rivera.jpg";
import BrianPerezHeadshot from "../../assets/Conductors/Brian_Perez.jpg";
import RobertHerringsHeadshot from "../../assets/Conductors/Robert_Herrings.jpg";
import CynthiaLansfordHeadshot from "../../assets/Conductors/Cindy_Lansford.jpg";

export const conductorData: ConductorCardProps[] = [
  {
  ...
  },
  {
    ...
    When away from work, Mr. Sommer loves to spend time with his wife, Lupe. Together they enjoy watching movies, cooking, running, and being with their families. Both he and his wife work in Leander ISD and are excited for their future together.

    Mr. Sommer feels honored to be a part of the Henry Band program and is extremely excited to work alongside some of the best students and educators in the state of Texas!
    `,
  },
  {
    name: "Jorge Rivera",
    ...
    Outside the band hall, Mr. Rivera enjoys spending time with his dog, Oliver, pursuing photography, traveling to new places, and hanging out with friends.
    `,
  },
  {
    name: "Brian Perez",
    title: "Director of Percussion",
    imgSrc: BrianPerezHeadshot,
    details: `Before joining the staff at Henry Middle School, Mr. Perez served as the Percussion Director at Klein Cain High School in Klein ISD beginning in 2017. At Klein Cain, he directed all percussion and steel drum ensembles, wrote percussion arrangements for the Cain Marching Band, and helped direct and manage percussionists at Ulrich and Doerre Intermediate Schools.

    Under his leadership, the Klein Cain marching percussion section earned numerous top percussion awards at area competitions, including Grand Champion honors in 2022 and 2023 at the Aldine Percussion Invitational. In 2023, the Klein Cain Percussion Studio was also selected to perform as a featured ensemble at the Music for All Percussion Festival in Indianapolis.

    Since aging out from the Santa Clara Vanguard (2000–2004), Mr. Perez has served on the percussion staff of several world-class Drum Corps International ensembles, including Santa Clara Vanguard, The Cavaliers, Madison Scouts, and The Cadets. He currently teaches with the Boston Crusaders Drum & Bugle Corps, where he has been on staff since 2017.

    Mr. Perez has been an active music educator in Texas for more than 20 years and holds a Bachelor’s Degree in Music Education from the University of Houston. In his free time, he likes spending time with family and sharing his passion for music education alongside his wife, Joni, and their three cats—Ziggy, Biskitt, and Diddle.
    `,
  },
  {
    name: "Robert Herrings",
    title: "Director of Bands - Vista Ridge High School",
    imgSrc: RobertHerringsHeadshot,
    details: `Robert Tyrome Herrings, III is in his twenty-first year of teaching and has been teaching in Leander ISD since 2004. Prior to his appointment as Director of Bands at Vista Ridge High School, he was the Director of Bands at Artie Henry Middle School.   
  ...
  },
  {
    ...
    Ms. Lansford retired from public school teaching in 2007; she is currently doing freelance work as a band consultant/clinician, mentor to young teachers, and adjudicator/clinician for contests and festivals all the way from Alaska to Georgia, and many places in between. Honor bands conducted include too many region bands to count, as well as all-state bands in both Arkansas and Georgia. 

    Ms. Lansford is a Past President of the Alpha Chapter of Phi Beta Mu and serves on the Hall of Fame Committee for the Alpha Chapter. She was inducted into the Phi Beta Mu Texas Bandmasters Hall of Fame in 2021 and is currently serving on the Board of Directors of Phi Beta Mu International. Ms. Lansford was recently voted into the membership of the American Bandmasters Association.
    `,
  },
];
